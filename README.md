...
add cloud backup if possible
Принимать перевод с русского и добавлять уже англ слово (сделать это отдельной вкладкой или режимом).
Плюс можно показывать сначала превью (чтоб ты мог в моменте узнать, как будет X на англ и кнопку "сохранить в список")
