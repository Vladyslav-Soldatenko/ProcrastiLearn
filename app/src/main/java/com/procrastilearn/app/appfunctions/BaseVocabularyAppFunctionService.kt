...
@AppFunctionServiceEntryPoint(
    serviceName = "VocabularyAppFunctionService",
    appFunctionXmlFileName = "vocabulary_app_function_service",
)
abstract class BaseVocabularyAppFunctionService : AppFunctionService() {
    @Inject
    internal lateinit var vocabularyEntryUseCases: VocabularyEntryUseCases

    @Inject
    internal lateinit var openAiStore: OpenAiPreferencesStore

    @Inject
    internal lateinit var aiTranslationProvider: AiTranslationProvider
