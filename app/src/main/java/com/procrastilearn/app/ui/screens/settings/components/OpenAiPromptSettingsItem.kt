...
fun OpenAiPromptSettingsItem(
    ...
    val supporting =
        if (prompt == OpenAiPromptDefaults.translationPrompt) {
            stringResource(R.string.settings_openai_prompt_default)
        } else {
            stringResource(R.string.settings_openai_prompt_custom)
        }

    ListItem(
        headlineContent = { Text(stringResource(R.string.settings_openai_prompt_title)) },
        supportingContent = {
            Text(
                supporting,
